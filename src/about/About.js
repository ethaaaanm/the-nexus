    ...
    return(
        <div className="about-page">
            ...
            <div className="mission-section">
                ...
                <h5 className="nexus-description">“Nexus” refers to a central point or link that connects different elements or groups. 
                ...
                <h4 className="romans-12">so in Christ we, though many, form one body, and each member belongs to all the others.<br/> <br/>ROMANS 12:5 </h4>
            </div>

            <div className="format-section">
                <h3 className="format-title">FORMAT BREAKDOWN</h3>
                <h5 className="format-description">Four Sports. Two Teams. One Champion.
